 ...
 * @since  1.0
 */
class JoomlogModelLog extends JModelAdmin
{
	/**
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Log', $prefix = 'JoomlogTable', $config = array())
	{
	...
	function saveit($data)
    {
        ...
        $table = $this->getTable('Log', 'JoomlogTable');
        $table->bind($data);
