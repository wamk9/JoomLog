 ...
 * @since  1.0
 */
class JoomlogModelVersion extends JModelAdmin
{
	/**
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Version', $prefix = 'JoomlogTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState(
			'com_joomlog.edit.versions.data',
			array()
		);
	...
	function saveit($data)
    {
        ...
        $table = $this->getTable('Version', 'JoomlogTable');
        $table->bind($data);
