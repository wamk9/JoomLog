 ...
 * @since  1.0
 */
class JoomlogViewLog extends JViewLegacy
{
	/**
	 * View form
	 *
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			$title = JText::_('COM_JOOMLOG_MANAGER_LOG_NEW');
		}
		else
		{
			$title = JText::_('COM_JOOMLOG_MANAGER_LOG_EDIT');
		}
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_JOOMLOG_MANAGER_LOG_CREATING') :
                JText::_('COM_JOOMLOG_MANAGER_LOG_EDITING'));
